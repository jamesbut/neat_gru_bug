...
void FitnessScore::Reset(bool indv_run, CVector3 arena_size, int env_num, std::string env_path) {
...
void FitnessScore::PostExperiment() {
   ...
   std::vector<CVector3> trajectory = trajectory_loop.get_trajectory();
