...
namespace NEAT {
	...
	extern double gru_compat_coeff;
	...
	extern double mutate_add_gru_node_prob;
	extern double mutate_add_link_prob;
	extern double mutate_delete_link_prob;
	...
	extern int num_gens; //Number of generations
	extern int num_trials; //Number of trials per individual
