...
SharedMem::SharedMem(int population_size, int num_trials) :
   SHARED_MEMORY_FILE_FITNESS("/SHARED_MEMORY_FITNESS"),
   SHARED_MEMORY_FILE_GOT_TO_TOWER("/SHARED_MEMORY_GOT_TO_TOWER"),
   SHARED_MEMORY_FILE_DISTANCE_FROM_TOWER_W_CRASH("/SHARED_MEMORY_DISTANCE_FROM_TOWER_W_CRASH"),
   SHARED_MEMORY_FILE_TRAJ_PER_ASTAR("/SHARED_MEMORY_TRAJ_PER_ASTAR"),
